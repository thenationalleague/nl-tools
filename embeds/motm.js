    ...
    (function () {
      ...
      function listenAll() {
        ...
        fbDb.ref('motm-windows').on('value', function (snap) {
          ...
          /* Denied or offline. Empty rather than null: null means "still loading"
             and would leave every row saying "opening shortly" forever. Empty means
             nothing is open, which is what the rule would enforce anyway. */
          state.windows = {};
          renderFixtures();
        });
