  ...
  function mount() {
    ...
    (function () {
      ...
      var ICON = {
        ...
        // cardYellow/cardRed.svg. Inlined rather than referenced, because a
      ...
      function windowCardHTML() {
        ...
        return '<div class="nlsm__windowcard">' +
          ...
          '<p>Pick your candidates for Team of the Week for 24 hours after a match.</p>' +
          list +
        '</div>';
      }
