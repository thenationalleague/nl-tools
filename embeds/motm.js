    ...
    (function () {
        ...
        hero.innerHTML =
          '<div class="nlsm__clubhero' + pale + '" style="--club-bg:' + $h(pal.primary) + ';--club-tx:' + $h(tx) + ';">' +
            ...
            '<span class="nlsm__clubwho">' +
              ...
              '<span class="nlsm__clubname">' +
                '<span class="nlsm__clubnamelbl">My team:</span> ' + $h(r.teamName) +
              '</span>' +
            '</span>' +
          '</div>' +
      ...
      function pickerHTML(m, draft, hadVote) {
        ...
        function teamCol(team, isHome) {
          ...
          return '<div class="nlsm__teamcol' + (isHome ? ' is-home' : '') + '" style="--team-primary:' + $h(palette.primary) + ';--team-secondary:' + $h(palette.secondary) + ';">' +
