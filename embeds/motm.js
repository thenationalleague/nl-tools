  ...
  function mount() {
    ...
    (function () {
      ...
      function renderHero() {
        ...
        var tx  = pickTextColor(pal.primary);
      ...
      function rowHTML(m, now) {
        ...
        // Name right-aligned into the crest, crest against the score: the two
        // rows then read as one block with a hard right edge, and the full club
        // name is always used rather than switching to a short one on mobile.
