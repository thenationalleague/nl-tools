...
(function () {
  ...
  function mount() {
    ...
    (function () {
      ...
      var ICON = {
        // Football: white ball, dark pentagon. Reads as a ball at 11px where a
        // full panel pattern would just look like a grey blob.
        goal: '<svg viewBox="0 0 16 16" width="13" height="13" aria-hidden="true">' +
                '<circle cx="8" cy="8" r="7" fill="var(--white)" stroke="currentColor" stroke-width="1.3"/>' +
                '<path d="M8 2.9 12.1 5.9 10.5 10.7h-5L3.9 5.9z" fill="currentColor"/>' +
                '<path d="M8 2.9V1M12.1 5.9l1.8-.6M10.5 10.7l1.1 1.5M5.5 10.7l-1.1 1.5M3.9 5.9l-1.8-.6" ' +
                  'stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/>' +
              '</svg>',
        card: '<svg viewBox="0 0 12 16" width="8" height="11" aria-hidden="true">' +
                '<rect x="1" y="1" width="10" height="14" rx="1.5" fill="currentColor"/>' +
              '</svg>',
        on:   '<svg viewBox="0 0 12 12" width="9" height="9" aria-hidden="true">' +
                '<path d="M6 1.5 11 8.5H1z" fill="currentColor"/></svg>',
        off:  '<svg viewBox="0 0 12 12" width="9" height="9" aria-hidden="true">' +
