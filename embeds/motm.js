...
(function () {
  ...
  function mount() {
    ...
    (function () {
      ...
      var ICON = {
        // Football: solid ring, centre pentagon, five patches hung off the rim —
        // one path, currentColor, seams punched with evenodd so they show the
        // row background rather than a hardcoded white. The first attempt drew a
        // white ball with a thin outline and it collapsed to a dot: at this size
        // the shape has to be carried by mass, not by line. 15px rather than 13
        // because below ~14 the seams fall under a pixel on a 1x screen and the
        // ball fills in to a blob.
        goal: '<svg viewBox="0 0 24 24" width="15" height="15" aria-hidden="true">' +
                '<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="' +
                  'M12 1A11 11 0 1 0 12 23A11 11 0 1 0 12 1Z ' +
                  'M12 3.3A8.7 8.7 0 1 1 12 20.7A8.7 8.7 0 1 1 12 3.3Z ' +
                  'M14.41 8.68 L15.9 13.27 L12 16.1 L8.1 13.27 L9.59 8.68Z ' +
                  'M8.8 7.59 L8.24 5.22A7.75 7.75 0 0 1 15.76 5.22 L15.2 7.59Z ' +
                  'M15.2 7.59 L17.29 6.33A7.75 7.75 0 0 1 19.61 13.48 L17.18 13.68Z ' +
                  'M17.18 13.68 L19.02 15.28A7.75 7.75 0 0 1 12.94 19.69 L12 17.45Z ' +
                  'M12 17.45 L11.06 19.69A7.75 7.75 0 0 1 4.98 15.28 L6.82 13.68Z ' +
                  'M6.82 13.68 L4.39 13.48A7.75 7.75 0 0 1 6.71 6.33 L8.8 7.59Z"/>' +
              '</svg>',
        card: '<svg viewBox="0 0 12 16" width="9" height="12" aria-hidden="true">' +
                '<rect x="1" y="1" width="10" height="14" rx="1.5" fill="currentColor"/>' +
              '</svg>',
