  ...
  function mount() {
    ...
    (function () {
      ...
      var state = {
        ...
        lbPage: 0,              // leaderboard page (10 rows each)
      ...
      function wireFilters() {
        ...
        if (mSel) mSel.addEventListener('change', function () {
          state.lbMonth = mSel.value; state.lbPage = 0; loadLeaderboard();
        });
        if (dSel) dSel.addEventListener('change', function () {
          state.lbDay = dSel.value; state.lbPage = 0; loadLeaderboard();
        });
      }
        ...
        var inner =
          ...
          pageRows.map(function (r, i) {
            ...
            return '<div class="nlsp__trow' + (me ? ' is-you' : '') + '">' +
              '<span class="nlsp__rank">' + pageRanks[i] + '</span>' +
      ...
      function wirePager() {
        ...
        el.addEventListener('click', function (e) {
          ...
          state.lbPage += (b.getAttribute('data-page') === 'next' ? 1 : -1);
          renderTable();
        });
      }
